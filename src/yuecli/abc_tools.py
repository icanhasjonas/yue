#!/usr/bin/env python3
# VENDORED VERBATIM from multimodal-art-projection/YuE @ bd90e4c,
# skills/yue2-music/scripts/abc_tools.py. Apache-2.0, Copyright (c) 2026 the YuE2
# authors (see LICENSE.abc_tools). Do not edit here: re-copy on upgrade so the
# dialect checks stay the upstream ones. yue-specific logic lives in abcmap.py.
